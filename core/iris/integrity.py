...
def _load_or_create_key() -> bytes | None:
    ...
    mid-write key as suspect (which left the loser's envelope
    unstamped — every stored tier floored to heuristic on the next
    read — under a false suspect-key warning)."""
