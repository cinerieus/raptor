...
from core.analysis.reachability import binary_call_edge_present
...
def test_binary_call_edge_precedes_entry_stage(monkeypatch) -> None:
    ...
    binary_call_edge."""
    from core.analysis.reach_audit import PRECEDENCE
...
def test_graph_store_reuse_requires_matching_binary_sha_and_keeps_requested_path(
    ...
    import hashlib
    from core.analysis.binary_oracle_edges import _try_graph_store
